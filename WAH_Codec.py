...
x = doWAHencode(16, getList('100000000000000000000000000000000000000000000000000000000000100001100110011111111111111111111111111111111111111111111111111111000000000000000000000000000000000000000100000111'))
y = doWAHdecode(16, getList(x))
print (y == '100000000000000000000000000000000000000000000000000000000000100001100110011111111111111111111111111111111111111111111111111111000000000000000000000000000000000000000100000111')
